      ...
      <form onSubmit={handleSubmit}>
        <div className="grid md:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 space-y-6">
            {/* General */}
            <Card className="rounded-2xl shadow-lg shadow-primary/10 border border-primary/20">
              <CardContent className="p-4 space-y-3">
                ...
                <Input
                  ...
                  className="border-primary/20 rounded-2xl"
                />
                ...
                <Textarea
                  ...
                  className="border-primary/20 border rounded-2xl"
                />
            ...
            <Card className="rounded-2xl shadow-lg shadow-primary/10 border border-primary/20">
              <CardContent className="p-4 space-y-4">
                ...
                <Button
                  ...
                  border border-primary/20 hover:bg-primary hover:text-white rounded-xl cursor-pointer"
                >
                  Add Variant
                </Button>
              </CardContent>
            ...
            <Card className="rounded-2xl shadow-lg shadow-primary/10 border border-primary/20">
              <CardContent className="p-4">
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gray-100 text-gray-500 border border-primary/20 
