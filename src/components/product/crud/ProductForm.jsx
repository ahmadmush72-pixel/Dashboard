              ...
              <Card className="rounded-2xl  shadow-lg shadow-primary/10">
                <CardContent className="p-4 space-y-3">
                  ...
                  <InputGroupInput
                    ...
                    className="border border-primary/10 p-3 rounded-2xl"
                  />
              ...
              <Card className="rounded-2xl  shadow-lg shadow-primary/10">
                <CardContent className="p-4 space-y-4">
                  ...
                  <Button
                    type="button"
                    onClick={addVariant}
                    className="bg-gray-100 text-gray-700 cursor-pointer hover:bg-primary hover:text-white rounded-xl px-4 py-2 border-primary/20"
                  >
                    Add Variant
                  </Button>
                </CardContent>
              ...
              <Card className="rounded-2xl  shadow-lg shadow-primary/10">
                <CardContent className="p-4">
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gray-100 font-semibold text-gray-700 border border-primary/10 hover:bg-primary hover:text-white rounded-xl cursor-pointer"
                  >
